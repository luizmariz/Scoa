...
public class AdministradorController {
	...
	@PutMapping(path="/{idAdministrador}")
	public ResponseEntity<Administrador> update(@PathVariable("idAdministrador") Long idUser,
	...
	@DeleteMapping(path ={"/{idAdministrador}"})
	public ResponseEntity<?> delete(@PathVariable("idAdministrador") Long idUser) {
	   return repository.findById(idUser)
	           .map(record -> {
